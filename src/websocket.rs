        ...
        .await?
        {
            ...
            Err(e) => match (tls_type, is_tls_type_cached, danger_accept_invalid_cert) {
                ...
                (TlsType::Rustls, false, Some(_)) => {
                    log::warn!(
                        "WebSocket connection with rustls-tls failed: {}, {:?}",
                        url,
                        e
                    );
                    bail!(e)
...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("127.0.0.1:41115"), "ws://127.0.0.1:41118");
        assert_eq!(check_ws("127.0.0.1:41116"), "ws://127.0.0.1:41118");
        assert_eq!(check_ws("127.0.0.1:41117"), "ws://127.0.0.1:41119");
        assert_eq!(check_ws("rustdesk.com:41115"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:41116"), "ws://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:41117"), "ws://rustdesk.com/ws/relay");
        ...
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:41115"),
            "ws://[0:0:0:0:0:0:0:1]:41118"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:41116"),
            "ws://[0:0:0:0:0:0:0:1]:41118"
        );
        assert_eq!(
            check_ws("[0:0:0:0:0:0:0:1]:41117"),
            "ws://[0:0:0:0:0:0:0:1]:41119"
        );
        assert_eq!(check_ws("rustdesk.com:41115"), "wss://rustdesk.com/ws/id");
        assert_eq!(check_ws("rustdesk.com:41116"), "wss://rustdesk.com/ws/id");
        assert_eq!(
            check_ws("rustdesk.com:41117"),
            "wss://rustdesk.com/ws/relay"
        );
        // set relay-server with default port
        Config::set_option("relay-server".to_string(), "127.0.0.1:41117".to_string());
        assert_eq!(check_ws("127.0.0.1:41115"), "ws://127.0.0.1:41118");
        assert_eq!(check_ws("127.0.0.1:41116"), "ws://127.0.0.1:41118");
        assert_eq!(check_ws("127.0.0.1:41117"), "ws://127.0.0.1:41119");
